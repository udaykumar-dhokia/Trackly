    ...
    <div className="max-w-6xl mx-auto space-y-8">
      <section className="flex flex-col gap-1">
        ...
        <p className="text-zinc-400 text-sm max-w-2xl">
          Manage your account preferences and view identity parameters synced
          via Auth0.
        </p>
      </section>

      <section>
        <div className="bg-[#141418] border border-white/10 rounded-none overflow-hidden shadow-lg space-y-0">
          <div className="p-6 border-b border-white/5 flex items-center gap-4 bg-white/5">
            <div>
              ...
              <p className="text-zinc-500 text-xs">
                Synchronized from your Auth0 Provider
              </p>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="bg-[#0f0f12] border border-white/5 rounded-lg px-4 py-3 text-zinc-200 shadow-inner flex items-center justify-between">
                  ...
                  {user?.email_verified && (
                    <span className="text-[10px] font-bold bg-emerald-500/10 text-emerald-400 px-2 py-1 rounded-md">
                      Verified
                    </span>
                  )}
                </div>
