...
const SOCIALS = [
    {
        ...
        icon: (
            <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" className="text-zinc-100">
                ...
                <div className="mx-auto max-w-[1080px] grid grid-cols-1 md:grid-cols-2 gap-3 items-start">
                    ...
                    <div className="about-glow relative bg-[#0f0f12] border border-white/6 rounded-none p-9 h-full overflow-hidden">
                        ...
                        <div className="flex items-center gap-2 mb-5">
                            ...
                            <span className="text-[11px] tracking-widest uppercase text-primary">About</span>
                        </div>
                            ...
                            <div className="w-13 h-13 rounded-none bg-[#141418] border border-white/10 flex items-center justify-content-center shrink-0 overflow-hidden" style={{ width: 52, height: 52 }}>
                                <img
                                    ...
                                    onError={(e) => {
                                        ...
                                        t.parentElement!.innerHTML = '<span style="font-size:18px;font-weight:700;color:#a78bfa;width:100%;height:100%;display:flex;align-items:center;justify-content:center">UD</span>'
                                    }}
                                />
                            </div>
                            <div>
                                <p className="text-[1.05rem] font-bold tracking-[-0.02em] text-zinc-100">Udaykumar Dhokia</p>
                                <p className="text-[.8rem] text-zinc-500 mt-0.5">Builder of Trackly · Software Developer</p>
                            </div>
                        </div>

                        {/* Bio */}
                        <p className="text-[.88rem] text-zinc-400 leading-[1.75] mb-6">
                            <strong className="text-zinc-200 font-semibold">Trackly was built out of a real frustration.</strong>{' '}
                            While working on agentic AI projects, I had no simple way to know how much each
                            feature was costing me — especially when using{' '}
                            <strong className="text-zinc-200 font-semibold">Groq</strong> or{' '}
                            <strong className="text-zinc-200 font-semibold">Ollama</strong> where model names
                            give no hint about the host platform.<br /><br />
                            I'm a Computer Engineering student from{' '}
                            <strong className="text-zinc-200 font-semibold">Ahmedabad</strong> with a focus on{' '}
                            <strong className="text-zinc-200 font-semibold">Full Stack Development</strong>,{' '}
                            <strong className="text-zinc-200 font-semibold">Agentic AI</strong>, and applied AI
                            systems — RAG, vector search, and LLM tooling.
                        </p>
                        ...
                        <div className="flex flex-col gap-2">
                            {SOCIALS.map(s => (
                                ...
                                >
                                    <div className={`w-7 h-7 rounded-[7px] border flex items-center justify-center shrink-0 ${s.iconBg}`}>
                                        {s.icon}
                                    </div>
                                    <div>
                                        <p className={`text-[.8rem] font-medium text-zinc-100`}>{s.label}</p>
                                        <p className="text-[.72rem] text-zinc-600 mt-px">{s.handle}</p>
                                    </div>
                    ...
                    <div className="contact-glow relative bg-[#0f0f12] border border-white/6 rounded-none p-9 h-full overflow-hidden">
                        ...
                        {/* Label */}
                        <div className="flex items-center gap-2 mb-5">
                            <span className="block w-[18px] h-px opacity-60" style={{ background: '#34d399' }} />
                            <span className="text-[11px] tracking-widest uppercase" style={{ color: '#34d399' }}>Contact</span>
                        </div>
                        ...
                        <p className="text-[.88rem] text-zinc-400 leading-[1.7] mb-7">
                            Whether it's a bug, a feature request, a partnership idea, or just curiosity about
                            how Trackly works — drop a message and I'll get back to you.
                        </p>

                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-2 gap-2.5 mb-3.5">
                                <div>
                                    <label className="block text-[10px] tracking-[.06em] uppercase text-zinc-500 mb-1.5">Name</label>
                                    <input
                                        type="text"
                                        required
                                ...
                                <div>
                                    <label className="block text-[10px] tracking-[.06em] uppercase text-zinc-500 mb-1.5">Email</label>
                                    <input
                                        type="email"
                                        required
                            ...
                            <div className="mb-3.5">
                                <label className="block text-[10px] tracking-[.06em] uppercase text-zinc-500 mb-1.5">Subject</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div className="mb-4">
                                <label className="block text-[10px] tracking-[.06em] uppercase text-zinc-500 mb-1.5">Message</label>
                                <textarea
                                    required
                                    rows={4}
                            ...
                            {!submitted ? (
                                ...
                                >
                                    {sending ? (
                                        ...
                                        <Button className='w-full border-2 border-black bg-white px-5 py-3 font-semibold text-black shadow-primary shadow-[4px_4px_0_0] hover:bg-indigo-300 focus:ring-2 focus:ring-indigo-300 focus:outline-0'>Send Message <ArrowUpRightIcon /></Button>
                                    )}
                                </button>
                            ) : (
                                <div className="flex items-center gap-2.5 px-4 py-3 rounded-[9px] border" style={{ background: 'rgba(52,211,153,0.08)', borderColor: 'rgba(52,211,153,0.2)' }}>
                                    <span className="pulse-dot w-1.5 h-1.5 rounded-full shrink-0" style={{ background: '#34d399', boxShadow: '0 0 6px #34d399' }} />
                                    <span className="text-[.78rem]" style={{ color: '#34d399' }}>Message sent — I'll reply within 24 hours.</span>
                                </div>
                            )}
                        </form>
                        ...
                        <div className="mt-5 pt-4 border-t border-white/6 flex items-center gap-2">
                            ...
                            <span className="text-[.78rem] text-zinc-500">
                                ...
                                <strong className="text-zinc-200 font-semibold">24 hours</strong>
                            </span>
                        </div>
                    </div>
